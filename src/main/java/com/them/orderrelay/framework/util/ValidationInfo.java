...
public class ValidationInfo {
     ...
     */
    public boolean isResiRegNum(String regno) {
        ...
        for (int index = 0; index < 12; index++) {
            if (!StringUtils.hasText(replaceno.substring(index, index + 1))) {
                return false;
            }
     ...
     */
    public boolean isCorpCertNum(String corpNumber) {
     ...
     */
    public boolean isBizRegNum(String bizNumber) {
     ...
     */
    public boolean isCellphoneNumber(String cellPhoneNumber) {
     ...
     */
    public boolean isRangeLength(String str, int min, int max) {
     ...
     */
    public boolean isRangeByteLength(String str, int min, int max) {
     ...
     */
    private String regexMetaCharEscape(String orgPattern) {
     ...
     */
    public boolean isUserFormat(String str, String pattern) {
     ...
     */
    public boolean isRegexPatternMatch(String str, String pattern) {
     ...
     */
    public boolean isPatternMatching(String str, String pattern) {
     ...
     */
    public boolean isPatternInclude(String str, String param) {
     ...
     */
    public boolean isRegexPatternInclude(String str, String pattern) {
